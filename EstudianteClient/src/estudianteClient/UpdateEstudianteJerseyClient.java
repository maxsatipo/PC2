 ...
 * USAGE:
 * <pre>
 *        UpdateEstudianteJerseyClient client = new UpdateEstudianteJerseyClient();
     ...
     public static void main(String args[])throws UniformInterfaceException
{
        ...
        ClientResponse response1= client1.find_XML(ClientResponse.class,"12526789");
        GenericType<Estudiante> genericType = new GenericType<Estudiante>() {};
        Estudiante estudiante=response1.getEntity(genericType);
        System.out.println("Nombre: "+estudiante.getNombre());
        System.out.println("DNI: "+estudiante.getDni());
        System.out.println("Apellido: "+estudiante.getApellido());
        System.out.println("Asignatura: "+estudiante.getAsignatura());
        System.out.println("Aula: "+estudiante.getAula());
        System.out.println("&&&&&&&&&&&&&&&&&&&&&&&&&&");
        estudiante.setDni(25849267); 
        estudiante.setAsignatura("Biología");
        client1.edit_XML(estudiante);
